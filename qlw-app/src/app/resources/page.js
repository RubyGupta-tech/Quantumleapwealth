              ...
              <div className="partners-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(210px, 1fr))", gap: "20px" }}>
                ...
                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.american-equity.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                ...
                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.annexus.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                ...
                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.corebridgefinancial.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                ...
                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.fidelity.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                ...
                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.nationwidenewheights.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                ...
                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.northamericancompany.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                ...
                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.fglife.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.fglife.com/" target="_blank" rel="noopener">Learn More →</a>
                </div>

                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.lincolnfinancial.com/public/individuals" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.lincolnfinancial.com/public/individuals" target="_blank" rel="noopener">Learn More →</a>
                </div>

                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.athene.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.athene.com/" target="_blank" rel="noopener">Learn More →</a>
                </div>

                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.allianz.com/en.html" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.allianz.com/en.html" target="_blank" rel="noopener">Learn More →</a>
                </div>

                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.ameritas.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.ameritas.com/" target="_blank" rel="noopener">Learn More →</a>
                </div>

                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.ethos.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.ethos.com/" target="_blank" rel="noopener">Learn More →</a>
                </div>

                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.americanamicable.com/v4/index.php" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.americanamicable.com/v4/index.php" target="_blank" rel="noopener">Learn More →</a>
                </div>

                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.mutualofomaha.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.mutualofomaha.com/" target="_blank" rel="noopener">Learn More →</a>
                </div>

                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.netlaw.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.netlaw.com/" target="_blank" rel="noopener">Learn More →</a>
                </div>

                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.agentpipeline.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.agentpipeline.com/" target="_blank" rel="noopener">Learn More →</a>
                </div>

                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://neishloss.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://neishloss.com/" target="_blank" rel="noopener">Learn More →</a>
                </div>
                <div style={{ gridColumn: "1 / -1", width: "100%", borderTop: "1px solid #e1e8ed", margin: "20px 0 10px 0", paddingTop: "20px" }}>
                  <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.5rem", color: "var(--primary)" }}>Available in Canada</h2>
                </div>

                {/* Canada 1 */}
                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.foresters.com/en-ca" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.foresters.com/en-ca" target="_blank" rel="noopener">Learn More →</a>
                </div>

                {/* Canada 2 */}
                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.cpp.ca" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.cpp.ca" target="_blank" rel="noopener">Learn More →</a>
                </div>

                {/* Canada 3 */}
                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://ia.ca/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://ia.ca/" target="_blank" rel="noopener">Learn More →</a>
                </div>

                {/* Canada 4 */}
                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.beneva.ca/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.beneva.ca/" target="_blank" rel="noopener">Learn More →</a>
                </div>

                {/* Canada 5 */}
                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.serenialife.ca/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.serenialife.ca/" target="_blank" rel="noopener">Learn More →</a>
                </div>

                {/* Canada 6 */}
                <div className="partner-card">
                  <div style={{ height: "45px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>
                    <a href="https://www.bmo.com/" target="_blank" rel="noopener" style={{ display: 'contents' }}>
                  ...
                  <a href="https://www.bmo.com/" target="_blank" rel="noopener">Learn More →</a>
                </div>
              </div>
            </div>
          </div>
