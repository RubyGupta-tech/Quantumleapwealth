      ...
      <section className="page-hero">
        <div className="container">
          <div className="breadcrumb" style={{ marginBottom: '15px' }}>
            ...
            <span style={{ color: 'var(--primary)', fontWeight: 'bold' }}>Financial Resource Center</span>
          </div>
          <h1>Financial <span style={{ color: "#c9a84c" }}>Resource Center</span></h1>
          <p>Explore our free financial tools and calculators to help you plan your future.</p>
        </div>
      </section>
      ...
      <section className="resources-section">
        <div className="container">
          <div className="resources-layout">
            ...
            {/* FULL COLUMN: Calculators */}
            <div className="resources-left" style={{ flex: "1 1 100%", maxWidth: "100%" }}>
              <div style={{ marginBottom: "32px", textAlign: "center" }}>
                <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.8rem", color: "var(--primary)" }}>
                  Interactive <span style={{ color: "#c9a84c" }}>Calculators</span>
                </h2>
              ...
              <div className="calc-list">
                ...
                <div className="calc-card" style={{ border: "1.5px solid #c9a84c", marginBottom: "20px", gridColumn: "1 / -1", maxWidth: "600px", margin: "0 auto" }}>
                  ...
                  <div className="calc-card-body-static">
                    ...
                    <a href="https://abacuswizard.com/login" target="_blank" rel="noopener noreferrer" className="calc-btn" style={{ textDecoration: "none", textAlign: "center", display: "inline-block", width: "auto", padding: "10px 20px", fontSize: "0.8rem", borderRadius: "6px" }}>
                      Access FNA
                    </a>
                  </div>
                </div>
                ...
                {/* Term Insurance Calculator */}
                <div className={`calc-card ${activeCalc === 0 ? 'active' : ''}`} style={{ marginBottom: 0 }}>
                ...
                {/* Retirement Calculator */}
                <div className={`calc-card ${activeCalc === 1 ? 'active' : ''}`} style={{ marginBottom: 0 }}>
                ...
                {/* College Fund Calculator */}
                <div className={`calc-card ${activeCalc === 2 ? 'active' : ''}`} style={{ marginBottom: 0 }}>
                ...
                {/* Investment Growth Calculator */}
                <div className={`calc-card ${activeCalc === 3 ? 'active' : ''}`} style={{ marginBottom: 0 }}>
