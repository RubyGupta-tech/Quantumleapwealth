...
NEW_NAVBAR_INNER_TEMPLATE = """
    <div class="navbar-inner">
      <a href="{rel}index.html" class="navbar-brand">
        <img src="{rel}images/Quantumleap_logo.png" alt="Quantum Leap Financial Services Logo" class="brand-logo" />
        <div class="brand-text">
          <strong class="brand-name">Quantum Leap Financial Services</strong>
